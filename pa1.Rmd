...
```{r  fig.cap="F1.StepsperDayFrequency"}
...
```{r  fig.cap="F2.TimeSeriesof5-minuteIntervals"}
...
```{r fig.cap="F3.StepsperDayFrequency"}
...
```{r fig.cap="F4.TimeSeriesof5-minuteIntervalssplitbyDayType"}
